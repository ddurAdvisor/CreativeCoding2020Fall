# CreativeCoding_2020Fall课前准备

## Course Materials for 创意编程

说明：本库为《创意编程》课程的教学以基于Java语言processing为主要IDE（也会涉及到javascript的一些编程工作），如果同学们熟悉其他的编程语言如C++、C#和集成开发环境如cinder和openFramework，也可以在本课程中进行使用。
